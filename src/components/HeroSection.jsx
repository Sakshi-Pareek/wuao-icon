...
import navdiscord from "../assets/images/png/nav_discord.svg";
import NavTwitter from "../assets/images/png/nav_twitter.svg";
import NavTelegram from "../assets/images/png/nav_telegram.svg";
import in_img from "../assets/images/png/in_img.svg";
// import Earthicon from "../assets/images/png/earth_icon.svg";
              ...
              <div className="d-flex align-items-center justify-content-center">
                <li className="me-3 icon_zoom">
                  <a
                    ...
                    rel="noreferrer"
                  >
                    <img src={navdiscord} alt="discord" />
                  </a>
                </li>
                <li className="me-3 icon_zoom">
                  <a
                    ...
                    rel="noreferrer"
                  >
                    <img src={NavTwitter} alt="twitter" />
                  </a>
                </li>
                <li className="me-3 icon_zoom">
                  <a
                    ...
                    rel="noreferrer"
                  >
                    <img src={NavTelegram} alt="telegram" />
                  </a>
                </li>
                <li className="me-3 icon_zoom">
                  <a
